<footer>
        		...
        		<div class="container-fluid">
            		<div class="row block-content">
						   ...
						   <img src="https://drive.google.com/uc?export=view&id=1M-AQTsnmeQrlnsemxz0IRZfEHuDNi-D8" width="200px" alt="Capy Logistics"/>
	                    ...
	                    <div class="col-sm-4 wow zoomIn" data-wow-delay="0.3s">
	                        ...
	                        <div class="contact-info">
	                            <span><i class="fa fa-location-arrow"></i><strong>Capy Logistics Ltd 
</strong><br>Sifa Towers, Kilimani,Ring Road</span>
	                            <span><i class="fa fa-phone"></i>+254 724 795 342 | +211 927 505 745 </span>
	                            <span><i class="fa fa-envelope"></i>capy@gmail.com </span>
	                            <span><i class="fa fa-clock-o"></i>Mon - Sat  8.00 - 17.00</span>
	                        </div>
	                    </div>
	                </div>
             		<div class="copy text-right"><a id="to-top" href="#this-is-top"><i class="fa fa-chevron-up"></i></a>Created by <a href="#">Astute Tech</a> &copy; 2023 Capy Logistics All rights reserved.</div>
	             </div>
	        </footer>