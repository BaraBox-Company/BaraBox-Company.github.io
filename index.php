...
<?php include 'header.php' ?>			
	            ...
	            <div class="item">
	                ...
	                <div class="container-fluid">
	                    <div class="slider-content col-md-6 col-lg-6">
	                        ...
	                        <p>We offer our fleet to customers for local deliveries in times of need where no international movement is relevant. A competitive warehouse and handling tariff is provided.<br><a class="btn btn-success" href="#">LEARN MORE</a></p>
	                    </div>
	                </div>
	            </div>
                <div class="item">
                 ...
                 <div class="item">
	                ...
	                <div class="container-fluid">
	                    <div class="slider-content col-md-6 col-lg-6">
	                        ...
	                        <p>We are able to offer domestic coverage on air freight and also assist in interconnections of flights schedules for Transit Cargo but only for West Malaysia.<br><a class="btn btn-success" href="#">LEARN MORE</a></p>
	                    </div>
	                </div>
	            </div>
                <div class="item">
	        ...
	        <div class="container-fluid">
        		<div class="row column-info block-content">
	                ...
	                <div class="col-sm-4 col-md-4 col-lg-4 wow fadeInUp" data-wow-delay="3.3s">
	                    ...
	                    <p> we are able to offer domestic coverage on air freight and also assist in interconnections of flights schedules for Transit Cargo but only for West Malaysia.</p>
	                ...
	                <div class="col-sm-4 col-md-4 col-lg-4 wow fadeInRight" data-wow-delay="3.3s">
	                    ...
	                    <p>We provide a reasonable yet comprehensive transportation network within East and South Malaysia road from the Port.</p>
	        ...
	        <div class="big-hr color-1 wow zoomInUp" data-wow-delay="0.3s">
        		<div class="text-left" style="margin-right:40px;">
            		...
            		<p>Capy Logistics is a well-established supply chain solution's firm majoring in logistics and consultancy.</p>
				</div>
				...
				<div class="row our-services">
	                ...
	                <div class="col-sm-6 col-md-4 col-lg-4 wow zoomInUp" data-wow-delay="0.3s">
                		<a href="road-trucking.php">
                    		...
                    		<h4>Road Trucking</h4>
	                        <p> The increased trade between states has stimulated haulage by road. Goods can be carried</p>
	                    </a>
	                </div>
	                ...
	                <div class="col-sm-6 col-md-4 col-lg-4 wow zoomInLeft" data-wow-delay="0.3s">
                		<a href="goods.php">
                            ...
                            <p>Capy has wide experience in handling Imports and Exports in Malaysia</p>
	                    </a>
	                </div>
	                <div class="col-sm-6 col-md-4 col-lg-4 wow zoomInUp" data-wow-delay="0.3s">
	                ...
	                <div class="col-sm-6 col-md-4 col-lg-4 wow zoomInRight" data-wow-delay="0.3s">
                		<a href="supply-chain-management.php">
                            ...
                            <p> Capy is capable of assisting reviewing procurement organizations for best practices and </p>
	                    </a>
	                </div>
	            </div>
	        </div>
				...
				<div class="info-texts wow fadeIn" data-wow-delay="0.3s">
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-sm-4 col-md-4 col-lg-4">
								<p>With the help of our partners we are providing specialized services in Logistics solutions to our satisfied customers</p>
							</div>
							<div class="col-sm-4 col-md-4 col-lg-4">
