...
<?php include 'header.php' ?>	
			...
			<div class="container-fluid inner-offset">
				<div class="hgroup text-center wow zoomIn" data-wow-delay="0.3s">
					...
					<h1>CAPYBOX LOGISTICS -    Service Delivery with Diligence </h1>
				</div>            
				...
				<div class="tab-content inner-offset wow fadeIn" data-wow-delay="0.3s">
					<div class="tab-pane active" id="tab1">
						<div class="row">
							...
							<div class="col-sm-7">
								<p><strong style="font-size:16px;">Capybox Logistics is a well-established procurement and logistics firm set up to offer back to back supply chain solutions.</strong></p>
					...
					<div class="tab-pane" id="tab2">
						<div class="row">
							...
							<div class="col-sm-7 text-block">
								<p><strong>Capybox Logistics is a well-established procurement and logistics firm set up to offer back to back supply chain solutions. The dynamic changes experienced in the supply chain industry require new ideas and approach.</strong></p>
								<p> Capybox Logistics endeavors to provide our customers with good service quality; we have carefully invested our resources to the service areas that matter most to our customers, this is why we are able to provide you with the unique service.
                                </p>
                                <p>
                                    Capyblox logistics has employed the best staff in its logistics operation to ensure that service provided is above the industry’s best practices</p>
